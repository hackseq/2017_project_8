...
if __name__ == "__main__":
    ...
    c_elegans_df.columns = ["Experimenter", "sgRNA", "sgRNA length", "Gene target", "30mer", "30mer length", "GuideSoftware", "Success", "WormsInjected",
    ...
    c_elegans_df = c_elegans_df.drop(axis=1, labels=["30mer length"])
